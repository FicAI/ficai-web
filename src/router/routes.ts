...
const routes: RouteRecordRaw[] = [
  { path: '/bex', name: 'bex', component: () => import('layouts/BexLayout.vue'),
    children: [
      { path: '', redirect: { name: 'tag-me-bex' }},
      { path: 'tag-me', name: 'tag-me-bex', component: () => import('pages/FicBexPage.vue'), meta: {requiresAuth: true} },
      { path: 'auth', component: () => import('pages/auth/AuthPage.vue'), children: [
          { path: '', redirect: { name: 'login-bex' }},
          { path: 'login', name: 'login-bex', component: () => import('pages/auth/LoginView.vue') },
          { path: 'register', name: 'register-bex', component: () => import('pages/auth/RegisterView.vue') },
        ]},
    ]},
  {
